...
if (index == obj_menu_controller.menu_index)
{
	if (!instance_exists(my_preview))
	{
	    ...
	    my_preview.weapon_name = "Spear";
	    my_preview.player1_weapon_unlocked = global.player1_weapon_unlocked_spear;
		my_preview.player2_weapon_unlocked = global.player2_weapon_unlocked_spear;
