...
if (index == obj_menu_controller.menu_index)
{
	if (!instance_exists(my_preview))
	{
	    ...
	    my_preview.wallet_name = "Reach Wallet";
	    my_preview.player1_wallet_unlocked = global.player1_wallet_unlocked_reach;
		my_preview.player2_wallet_unlocked = global.player2_wallet_unlocked_reach;
		...
		my_preview.wallet_bonus = "+ 4 reach";
	}
}
else
{
