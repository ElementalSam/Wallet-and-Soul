...
if (index == obj_menu_controller.menu_index)
{
	if (!instance_exists(my_preview))
	{
	    ...
	    my_preview.wallet_name = "Health Wallet";
	    my_preview.player1_wallet_unlocked = global.player1_wallet_unlocked_health;
		my_preview.player2_wallet_unlocked = global.player2_wallet_unlocked_health;
		...
		my_preview.wallet_bonus = "+ 1 max health";
	}
}
else
{
