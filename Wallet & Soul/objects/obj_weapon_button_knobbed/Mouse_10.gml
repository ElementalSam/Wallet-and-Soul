...
if (!instance_exists(my_preview))
{
    ...
    my_preview.weapon_name = "Knobbed Mace";
    my_preview.player1_weapon_unlocked = global.player1_weapon_unlocked_knobbed;
	my_preview.player2_weapon_unlocked = global.player2_weapon_unlocked_knobbed;
	...
	my_preview.weapon_other = "+ 2 dash speed";
}
