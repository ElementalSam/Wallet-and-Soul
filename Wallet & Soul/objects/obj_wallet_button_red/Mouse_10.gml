...
if (!instance_exists(my_preview))
{
    ...
    my_preview.wallet_name = "Red Wallet";
    my_preview.player1_wallet_unlocked = global.player1_wallet_unlocked_red;
	my_preview.player2_wallet_unlocked = global.player2_wallet_unlocked_red;
