...
if (!instance_exists(my_preview))
{
    ...
    my_preview.weapon_name = "Gladius";
    my_preview.player1_weapon_unlocked = global.player1_weapon_unlocked_gladius;
	my_preview.player2_weapon_unlocked = global.player2_weapon_unlocked_gladius;
	...
	my_preview.weapon_other = "+ 2 max health";
}
