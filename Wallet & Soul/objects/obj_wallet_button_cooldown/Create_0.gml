...
function execute_action(player)
{
	...
	{
		var cost = 50;
		if (!global.player1_wallet_unlocked_cooldown)
		{
		        ...
		        global.player1_soul_count_yellow >= cost)
		    {
		        ...
		        global.player1_wallet_unlocked_cooldown = true;
		    }
		    else
		    {
		...
		global.player1_selected_wallet = obj_wallet_cooldown;
	...
	{
		var cost = 50;
		if (!global.player2_wallet_unlocked_cooldown)
		{
		        ...
		        global.player2_soul_count_yellow >= cost)
		    {
		        ...
		        global.player2_soul_count_yellow -= cost;
				audio_play_sound_on(global.emitter_sound, snd_item_unlock, 0, false);
		        global.player2_wallet_unlocked_cooldown = true;
		    }
		    else
		    {
				audio_play_sound_on(global.emitter_sound, snd_item_locked, 0, false);
		...
		global.player2_selected_wallet = obj_wallet_cooldown;
