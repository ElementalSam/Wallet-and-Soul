...
if (index == obj_menu_controller.menu_index)
{
	if (!instance_exists(my_preview))
	{
	    ...
	    my_preview.wallet_name = "Cooldown Wallet";
	    my_preview.player1_wallet_unlocked = global.player1_wallet_unlocked_cooldown;
		my_preview.player2_wallet_unlocked = global.player2_wallet_unlocked_cooldown;
		...
		my_preview.wallet_bonus = "- 0.25 dash cooldown";
	}
}
else
{
