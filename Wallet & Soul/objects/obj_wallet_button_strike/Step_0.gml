...
if (index == obj_menu_controller.menu_index)
{
	...
	{
	    my_preview = instance_create_layer(x - 450, y - 250, "Instances", obj_wallet_preview);
	    my_preview.wallet_name = "Strike Wallet";
	    my_preview.player1_wallet_unlocked = global.player1_wallet_unlocked_strike;
		my_preview.player2_wallet_unlocked = global.player2_wallet_unlocked_strike;
		...
		my_preview.wallet_bonus = "- 0.20 attack cooldown";
	}
}
else
{
