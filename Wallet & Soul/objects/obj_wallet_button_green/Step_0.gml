...
if (index == obj_menu_controller.menu_index)
{
	if (!instance_exists(my_preview))
	{
	    ...
	    my_preview.wallet_name = "Green Wallet";
	    my_preview.player1_wallet_unlocked = global.player1_wallet_unlocked_green;
		my_preview.player2_wallet_unlocked = global.player2_wallet_unlocked_green;
		...
		my_preview.soul_bonus_green = 12;
