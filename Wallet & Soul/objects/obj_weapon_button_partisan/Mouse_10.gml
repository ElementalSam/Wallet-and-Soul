...
if (!instance_exists(my_preview))
{
    ...
    my_preview.weapon_name = "Partisan";
    my_preview.player1_weapon_unlocked = global.player1_weapon_unlocked_partisan;
	my_preview.player2_weapon_unlocked = global.player2_weapon_unlocked_partisan;
	...
	my_preview.weapon_other = "Can destroy \nShade Blades";
}
